...
function SidebarTrigger({
  ...
  // Grab the real-time layout state from your sidebar context
  ...
  return (
    ...
    >
      {open ? (
        <AlignEndVertical className="size-5 animate-in fade-in zoom-in-95 duration-150" />
      ) : (
        <AlignStartVertical className="size-5 animate-in fade-in zoom-in-95 duration-150" />
      )}
